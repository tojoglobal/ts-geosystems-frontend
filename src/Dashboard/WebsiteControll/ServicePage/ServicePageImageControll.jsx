...
const ServcePageImageControll = () => {
  ...
  useEffect(() => {
    const fetchImages = async () => {
      try {
        const response = await axiosPublicUrl.get("/api/get-service-images");
  ...
  const onSubmit = async () => {
    try {
      ...
      await axiosPublicUrl.put("/api/update-service-images", formData, {
...
export default ServcePageImageControll;
