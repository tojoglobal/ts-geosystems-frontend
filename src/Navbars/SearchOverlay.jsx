...
const RECOMMENDED_PRODUCTS = [
  {
    ...
    price: "£3.95",
    image:
      "https://cdn11.bigcommerce.com/s-ew2v2d3jn1/product_images/uploaded_images/retro-reflective-targets.jpg",
  },
  {
    name: "Leica Cyclone REGISTER 360 PLUS",
    price: "£162.00",
    image:
      "https://cdn11.bigcommerce.com/s-ew2v2d3jn1/product_images/uploaded_images/r360.png",
  },
  {
    name: "Leica GEB212 Li-Ion Battery",
    price: "£179.95",
    image:
      "https://cdn11.bigcommerce.com/s-ew2v2d3jn1/product_images/uploaded_images/battery.jpg",
  },
  {
    name: "Leica GS16 SmartAntenna GPS",
    price: "£7,020.00",
    image:
      "https://cdn11.bigcommerce.com/s-ew2v2d3jn1/product_images/uploaded_images/gs16.jpg",
  },
];
...
const SearchOverlay = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      {/* top Section */}
      <div className="flex max-w-[99%] mx-auto items-center pt-6 p-4">
        {/* logo */}
        <img
