      ...
      <div className="p-2 md:p-3">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <p className="mb-6 text-sm">
            Please fill in the form, together with your any specific
            requirements, and we will reply with a customized quote. For queries
            please{" "}
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-4">
                    ...
                    <label className="flex items-center gap-2">
                      <input type="radio" name="companyType" value="PLC" />
                      <span>PLC</span>
                    </label>
                    <label className="flex items-center gap-2">
                      <input
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-4">
                  ...
                  <label className="flex items-center gap-2">
                    <input type="radio" name="emailInvoices" value="No" />
                    <span>No</span>
                  </label>
                </div>
                <input
