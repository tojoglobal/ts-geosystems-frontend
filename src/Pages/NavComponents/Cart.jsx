...
const Cart = () => {
  ...
  return (
    <div className="p-3">
      ...
      {/* Title */}
      <h1 className="text-3xl mb-2">Your Cart ({cartItems.length} Items)</h1>
      {/* Table */}
            ...
            <tr key={item.id} className="border-b">
              ...
              <td>
                <div className="flex items-center">
                  ...
                  <span className="px-2 border rounded">{item.quantity}</span>
                  <button
                    onClick={() => updateQuantity(item.id, 1)}
                    className="px-2 border rounded hover:bg-gray-200"
                  >
      ...
      <div className="max-w-lg ml-auto p-4 rounded">
        ...
        <div className="flex justify-end mt-7">
          ...
          <div className="text-sm text-right text-gray-500 mb-4">-- or use --</div>
        <div className="flex flex-col w-3/5 ml-auto items-center mt-4">
          ...
          <button className="bg-[#f3a847] text-black py-[6px] px-6 rounded w-full">
            ...
            <p className="uppercase font-semibold text-sm">use your amazon account</p>
        </div>
      </div>
    </div>
  );
