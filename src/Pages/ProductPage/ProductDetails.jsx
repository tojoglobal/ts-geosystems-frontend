        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="flex-1">
            ...
            <div className="mb-1 text-[#8d7f90]">
              ...
              <span className="text-[#e62245]"> Total Station / Kolida</span>
            </div>
            <div className="mb-1 text-[#8d7f90]">
              <strong>Tags:</strong>
            ...
            {activeTab === "OVERVIEW" && (
              <div className="text-gray-700 leading-relaxed">
                <p>
                  ...
                  Cupiditate quae illo soluta sapiente minus voluptatibus
                  molestias voluptates maiores repudiandae, velit quaerat error!
                  Dolor alias voluptates rerum vitae ilium officiis laboriosam,
                  eos fugiat necessitatibus iste quasi vero porro at asperiores
                  atque numquam adipisci esse perferendis hic dolore dolores
                  facere quidem? Voluptatum, nemo voluptates. Qui, animi edit
                  voluptatem velit nostrum rem maiores. Qui esse magnam enim
                  natus numquam ab adipisci nihil mollitia odio ducimus
                  architecto unde harum saepe illum, ipse hic dicta alias cumque
                  et minus veritatis assumenda a quo. Possimus, vitae est! Fuga
                  quidem minima sunt modi.
                </p>
              </div>
            )}
                  ...
                  <tbody>
                    {specifications.map((spec, index) => (
                      <tr key={index} className="border-t">
                        <td className="p-4 text-gray-700">{spec.name}:</td>
                        <td className="p-4 text-gray-700">{spec.value}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
