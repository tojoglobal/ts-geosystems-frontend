...
const CategoryBanner = () => {
  ...
  return (
    <div className="max-w-[1370px] mt-10 mx-3 md:mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 md:gap-5">
        ...
        >
          <div className="overflow-hidden border border-gray-200 rounded-[4px]">
            <img
              ...
              className="w-full mx-auto h-48 lg:h-64 object-cover transition-transform duration-300 group-hover:scale-110"
            />
          </div>
