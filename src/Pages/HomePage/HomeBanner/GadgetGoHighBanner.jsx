...
const GadgetGoHighBanner = () => {
  ...
  if (isLoading)
    return (
      <div className="md:w-full my-3 md:my-5 px-3 md:px-0 w-full md:max-w-[95%] 2xl:max-w-[1370px] mx-auto">
        <div className="flex h-80 sm:h-[190px] md:h-72 w-full flex-col sm:flex-row gap-3 md:gap-4">
          <div className="w-full sm:w-[33%] h-full bg-gray-200 animate-pulse rounded-md" />
          <div className="w-full sm:w-[67%] h-full bg-gray-200 animate-pulse rounded-md" />
        </div>
      </div>
    );
  ...
  return (
    <div className="md:w-full my-3 md:my-5 px-3 md:px-0 w-full md:max-w-[95%] 2xl:max-w-[1370px] mx-auto">
      <div className="flex h-80 sm:h-[190px] md:h-72 w-full flex-col sm:flex-row gap-3 md:gap-4">
        <div className="w-full sm:w-[33%] overflow-hidden rounded-md group h-full">
          {left?.imageUrl ? (
            <img
        ...
        <div className="w-full sm:w-[67%] md:relative group overflow-hidden rounded-md h-full">
          {right?.imageUrl ? (
            <img
