                    ...
                    <div className="border-2 border-[#e5e5e5] p-4">
                        {activeTab === "OVERVIEW" && (
                            <div className="text-gray-700 leading-relaxed">
                                <p>
                                    ...
                                    adipisicing elit. Cupiditate quae illo
                                    soluta sapiente minus voluptatibus molestias
                                    voluptates maiores repudiandae, velit
                                    quaerat error! Dolor alias voluptates rerum
                                    vitae ilium officiis laboriosam, eos fugiat
                                    necessitatibus iste quasi vero porro at
                                    asperiores atque numquam adipisci esse
                                    perferendis hic dolore dolores facere
                                    quidem? Voluptatum, nemo voluptates. Qui,
                                    animi edit voluptatem velit nostrum rem
                                    maiores. Qui esse magnam enim natus numquam
                                    ab adipisci nihil mollitia odio ducimus
                                    architecto unde harum saepe illum, ipse hic
                                    dicta alias cumque et minus veritatis
                                    assumenda a quo. Possimus, vitae est! Fuga
                        ...
                        {activeTab === "PRODUCT VIDEOS" && (
                            <div className="flex justify-center">
                                <div className="w-[640px] h-[360px] bg-gray-100 rounded-lg flex items-center justify-center">
